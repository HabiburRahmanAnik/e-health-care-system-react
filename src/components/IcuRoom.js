...
const ICU = () => {
    ...
    const handleInput = (e) => {
        ...
        e.persist();
        setIRoom({ ...IRoom, [e.target.name]: e.target.value });
    }

    const [ICURoom, setICURoom] = useState([]);

    useEffect(() => {
        loadICURoom();
    }, []);

    const loadICURoom = async () => {
        const result = await axios.get("http://127.0.0.1:8000/api/doctor/icuRoom/{id}");
        setICURoom(result.data);
        //console.log(result);
        ...
        <div>
            ...
            <div class="admin-wrapper">
                ...
                <div class="admin-content">
                    ...
                    <br /><br />
                    <b>____________________________________Intensive Care Unit (ICU) ____________________________________</b>
                    <table>
                        <tr>
