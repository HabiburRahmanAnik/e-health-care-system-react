...
const Dashboard = () => {
    ...
    const loadAuthority = async () => {
        const result = await axios.get("http://127.0.0.1:8000/api/doctor/checkReport/{id}");
        setCheckReport(result.data);
        //console.log(result);
        ...
        <div>
            ...
            <div class="admin-wrapper">
                ...
                <div class="admin-content">
                    ...
                    {CheckReport.map((Report, index) => {
                            return (
                                <div class="col-4">
                                <b>Patient Name : {Report.name}</b> <br />
                                <b>Prescription Repory : {Report.prescription}</b>  <br />
                                <b>Tests Report : {Report.tesrs}</b><br />
