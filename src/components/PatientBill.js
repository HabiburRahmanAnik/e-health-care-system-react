...
const PatientBill = () => {
    ...
    const onSubmit = (e) => {
        ...
        axios.post("http://127.0.0.1:8000/api/reception/createbill",Bill);
       ...
       <tr height="600px">
           ...
           <td>													
                            <table border="1" align="center">
					            ...
					            <tr>
						            <td> <input type="text" name="name" value={Bill.name} onChange={handleInput}/></td>
                                    <td><input type="text" name="token" value={Bill.token} onChange={handleInput}/></td>
                                    <td><input type="text" name="tbill" value={Bill.tbill} onChange={handleInput}/></td>
                                    <td><input type="text" name="pbill" value={Bill.pbill} onChange={handleInput}/></td>
                                    <td><input type="text" name="dbill" value={Bill.dbill} onChange={handleInput}/></td>
                                    
					            </tr>	
                                <tr>
                                    
                                    <input type="submit" style={{backgroundColor: "green"}} name="submit" value="Create Bill"/>
